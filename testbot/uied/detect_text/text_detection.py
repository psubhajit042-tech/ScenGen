from testbot.uied.detect_text.ocr import OCRDetector
from testbot.uied.detect_text.Text import Text
from testbot.utils import remove_punctuation
import numpy as np
import cv2
import json
import time
...
def text_detection(input_file, output_file, show=False):
    ...
    ocr_model = detector.get_model(detector.default_model_name)
